...
<div align="center">
  ...
  <h3 align="center">Önder Grup Android</h3>

  <p align="center">
    Önder Grup android projesi!
    <br />
...
Önder Grup mobil uygulamasıdır. Yalnızca android işletim sistemlerinde çalışmaktadır.

Programın yapabildikleri:
* Giriş yapabilme
* Kayıt olabilme
* Şifre sıfırlayabilme
* Makine durumunu kontrol edebilme
* Alt kullanıcı ekleyebilme
* Alt kullanıcıları yönetebilme
* Bildirimleri görüntüleyebilme
* Makine eşleyebilme
* Destek talebi oluşturabilme
- Kullanıcı yönetebilme
- Makine yönetebilme
- Destek taleplerini görüntüleyebilme

Tabii ki programın - ile işaretli kısımlarına yalnızca ENGINEER, TECHNICIAN ve SYSOP türündeki kullanıcılar erişebilir :smile:
