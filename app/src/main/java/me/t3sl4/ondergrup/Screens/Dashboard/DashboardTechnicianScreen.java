...
public class DashboardTechnicianScreen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        weatherButton.setOnClickListener(v -> {
            Intent weatherIntent = new Intent(DashboardTechnicianScreen.this, WeatherScreen.class);
        ...
        belgelerButton.setOnClickListener(v -> {
            Intent belgelerIntent = new Intent(DashboardTechnicianScreen.this, DocumentsScreen.class);
