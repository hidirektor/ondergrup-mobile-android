...
public class MaintenanceAllAdapter extends BaseAdapter {
    private Util util;
    private Context context;
    private ArrayList<Maintenance> machineMaintenanceList;

    public MaintenanceAllAdapter(Context context, ArrayList<Maintenance> machineMaintenanceList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(context).inflate(R.layout.activity_maintenancelog_all_list_item, parent, false);
            ...
            holder.machine_id = convertView.findViewById(R.id.maintenance_machine_id);
        ...
        try {
            ...
            if (maintenanceDateStr.contains(".") || maintenanceDateStr.contains("/")) {
                ...
                formattedDate = Util.dateTimeConvert(maintenanceDateStr);
            }
        } catch (Exception e) {
        ...
        String idText = context.getResources().getString(R.string.machine_id) + " " + machineMaintenance.getMachineID();
        holder.machine_id.setText(idText);
